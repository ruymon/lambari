    ...
    <div className="flex flex-col h-screen w-screen">
      ...
      <div className="flex h-full w-full bg-white dark:bg-gray-900">
        ...
        <main className="flex h-full w-full">
          <aside className="flex flex-col gap-1 lg:w-1/4 h-full overflow-y-auto border-r dark:border-gray-800/50 border-gray-300">
            <div className="px-6 py-8 pb-16 flex flex-col gap-1 items-start bg-cover bg-bottom bg-no-repeat dark:bg-[url('./assets/appeal_bg.png')]">
              ...
              <div className="w-full flex flex-col gap-4">
                <div className="flex flex-col">
                  ...
                  <span className="text-gray-500 tex-sm">
                    ...
                    <code className="bg-gray-300 text-gray-500 dark:bg-gray-800 px-1 rounded-sm text-sm font-bold">
                      ID
                    </code>{' '}
                    do Discord.
                  </span>
